...
def main() -> None:
    ...
    try:
        ...
        while True:
            ...
            if gamepad_action != previous_gamepad_action:
                print("gamepad_action=", gamepad_action, flush=True)
                previous_gamepad_action = dict(gamepad_action)
